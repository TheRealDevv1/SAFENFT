...
<p>Earn BNB simply by holding NxtGem Finance Token</p></div>
				...
				<a class="et_pb_button et_pb_custom_button_icon et_pb_button_1 et_hover_enabled et_pb_bg_layout_light" data-icon="ð">POO CHART - SOON</a>
			</div>
				...
				<a class="et_pb_button et_pb_custom_button_icon et_pb_button_3 et_hover_enabled et_pb_bg_layout_light" data-icon="ó">Pancakeswap - SOON</a>
			</div>
				...
				<a class="et_pb_button et_pb_custom_button_icon et_pb_button_5 et_hover_enabled et_pb_bg_layout_light" data-icon="Ø">CLAIM BNB - SOON</a>
			</div>
			</div> <!-- .et_pb_column -->
...
<p>We have worked extremely hard to bring you the best experience possible by holding your NxtGem Tokens. View our features below.</p></div>
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p>Dx Sale will be announced on June 10th. Ownership will be renounced,Â  which makes us 100% rug proof.</p></div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
...
<div class="div-para">
<p class="paragraph">Â All initial liquidity will be locked by Dx. Ownership will be renounced making it safe for allÂ  NxtGem</p>
</div>
</div>
</div>
</div>
...
<div></div>
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p style="text-align: center;"><span>NFTs are a huge part of DEFI and we definitely wonâ€™t miss out on this one! Â NxtGem Finance will have its own unique Space NFTs!</span></p></div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p style="text-align: center;"><span>An online Crypto payment based shop, where items are bought with $NxtGem. Even if a user doesnâ€™t hold $NxtGem- no problem, our code will convert their BNB into $NxtGem.</span></p></div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
			</div> <!-- .et_pb_column -->
...
<p>Visit our Telegram, we have a very active and engaged community to help our project flourish and turn our followers and community members into family.</p></div>
				...
				<a class="et_pb_button et_pb_custom_button_icon et_pb_button_7 et_hover_enabled et_pb_bg_layout_light" data-icon="ó">BUY ON PANCAKESWAP - SOON</a>
			</div>
			</div> <!-- .et_pb_column -->
